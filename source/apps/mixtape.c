...
static struct note chicken_pot_pie_notes[] = {
kick_drum,
	{ NOTE_G4, eighth_note, },
{ NOTE_D3, sixteenth_note, },
...
static struct note helipop_notes[] = {
...
static struct track playlist[] = {
	...
	{ "helipop", { .num_notes = ARRAY_SIZE(helipop_notes), .note = helipop_notes} },
	{ "chicken pot pie",  { .num_notes = ARRAY_SIZE(chicken_pot_pie_notes), .note = chicken_pot_pie_notes} },
