...
You will want to change the target from `[all]` in the same bar at the bottom to `[badge2025_c]`.
...
If the build is successful, a firmware blob will be produced at `build/source/badge2025_c.uf2`.
...
program is called `build_sdl_sim/source/badge2025_c`, which you can run.  It is compiled with debug information and
